...
namespace DevelopmentChallenge.Data.Tests.Refactorizacion
{
    ...
    public class RefactorizacionDataTests
    {
        ...
        {
            Assert.AreEqual($"<h1>{mensajeEsperado}</h1>",
                   FormaGeometrica.Imprimir(new List<FormaGeometrica>(), idiomaId));
        }
        ...
        public void TestTrianguloArea(decimal lado, decimal areaEsperada)
        {
            ...
            Assert.AreEqual(areaEsperada, decimal.Round(triangulo.CalcularArea(), 3));
        }
        ...
        public void TestCirculoArea(decimal radio, decimal areaEsperada)
        {
            ...
            Assert.AreEqual(areaEsperada, decimal.Round(circulo.CalcularArea(), 3));
        }
        ...
        {
            var circulo = new Circulo(radio);
            Assert.AreEqual(perimetroEsperado, decimal.Round(circulo.CalcularPerimetro(), 3));
        }
        ...
        {
            var trapecio = new Trapecio(baseInferior, baseSuperior, altura);
            Assert.AreEqual(perimetroEsperado, decimal.Round(trapecio.CalcularPerimetro(), 3));
        }
        ...
        public void TestProveedorIdioma(Idioma idioma, string tituloEsperado, string etiquetaFormasEsperada, string etiquetaPerimetroEsperada)
        {
            ...
            Assert.AreEqual(tituloEsperado, proveedor.ObtenerTituloReporte());
            Assert.AreEqual(etiquetaFormasEsperada, proveedor.ObtenerEtiquetaFormas(2));
            Assert.AreEqual(etiquetaPerimetroEsperada, proveedor.ObtenerEtiquetaPerimetro());
        }
